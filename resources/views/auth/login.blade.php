...
<div class="login-box" style="margin-top:-10%">
    <div class="login-logo img-fluid ">
        <a href="{{ url('/home') }}">
        <img class="col-md-12" src="images/logo2.png" style="margin-top:+10%"></a>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading"><center>Logar<center></div>
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group">
                            <div class="col-md-12 col-md-offset-4">
                              <p> <center> <button type="submit" class="btn btn-primary"><center>
                                    Login
                                </button></p>
